...
export default function RafflePage() {
  const raffles = [
    {
      ...
      description:
        "Win the latest iPhone 14 Pro. Enter now for a chance to upgrade your mobile experience!",
      entryCost: 500,
      totalEntries: 10000,
      currentEntries: 7500,
      endDate: "2023-07-15",
    ...
    },
    {
      ...
      description:
        "Enter for a chance to win $1000 in cash. Use it for anything you want!",
      entryCost: 250,
      totalEntries: 20000,
    ...
    },
    {
      ...
      description:
        "Win a PS5 console with two controllers and 3 games of your choice!",
      entryCost: 400,
      totalEntries: 15000,
      currentEntries: 9000,
      endDate: "2023-07-20",
    ...
    },
    {
      ...
      description:
        "Win a weekend getaway for two at a 5-star spa resort. Relax and rejuvenate!",
      entryCost: 600,
      totalEntries: 5000,
      currentEntries: 2000,
      endDate: "2023-07-25",
    ...
    },
    {
      ...
      description:
        "Win a custom-built gaming PC with top-of-the-line components. Perfect for serious gamers!",
      entryCost: 750,
      totalEntries: 8000,
      currentEntries: 4500,
      endDate: "2023-07-30",
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="mb-6 text-3xl font-bold">Active Raffles</h1>
            ...
            <CardContent className="flex-grow">
              <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center">
                  <Ticket className="mr-1 h-4 w-4 text-green-500" />
              ...
              <div className="mb-2">
                <div className="mb-1 flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {raffle.currentEntries} / {raffle.totalEntries}
                  </span>
                </div>
                <Progress
                  value={(raffle.currentEntries / raffle.totalEntries) * 100}
                />
              </div>
              <div className="flex items-center">
